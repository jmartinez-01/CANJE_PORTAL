...
<head>
  ...
  <title>Factura - Portal de Fidelización</title>
  ...
  <style>
    ...
    .table th, .table td {
      ...
      padding: 3px; /* Reducir aún más el relleno de las celdas */
    }
    ...
    @media print {
      .invoice {
        width: 100%; /* Ajustar el ancho para impresión */
        margin: 0;
      }
      
      .table-responsive {
        max-width: 100%; /* Hacer que la tabla ocupe el 100% */
        overflow: hidden;
      }
      
      .table {
        width: 100%; /* Ocupa el 100% del contenedor */
        table-layout: fixed; /* Ajuste de tabla para evitar desbordamientos */
      }
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-12 text-center">
          ...
          </i> Portal de Fidelización
            <br>
            <small>Fecha: 2/08/2024</small>
          </h2>
        </div>
      </div>
